...
CREATE TABLE IF NOT EXISTS dishwasher_data (
  ...
  temp_constant_4_above_setpoint BOOLEAN DEFAULT FALSE,
...
BEGIN
    ...
    IF NEW.latency_seconds IS NULL THEN
...
CREATE TRIGGER event_latency_trigger
